...
var fight = function(enemyName) {
    while (playerHealth > 0 && enemyHealth > 0) {
        ...
        console.log(
            playerName + ' attacked ' + enemyName + ' with a damage of ' + damage + '. ' + enemyName + ' now has ' + enemyHealth + ' health remaining.'
        );
        ...
        console.log(
            enemyName + ' attacked ' + playerName + ' with a damage of ' + damage + ". " + playerName + ' now has ' + playerHealth + ' health remaining.'
        );
...
var startGame = function() {
    ...
    for (var i = 0; i < enemyNames.length; i++) {
        if (playerHealth > 0) {
            ...
            enemyHealth = randomNumber(10, 100);
